 ...
 */
package com.appointext.classifiers;

import com.appointext.dataobjects.Document;
import com.appointext.dataobjects.FeatureStats;
import com.appointext.dataobjects.NaiveBayesKnowledgeBase;
import com.appointext.features.FeatureExtraction;
import com.appointext.features.TextTokenizer;
...
public class NaiveBayes {
	...
	//TODO: Tweak to obtain best results. 
     ...
     * @throws IllegalArgumentException
     */
    public Map<String, Double> predict(String text) throws IllegalArgumentException {
        ...
        Map<String, Double> confidence = new HashMap<String, Double>(); //Will store the score for each category. Categories being "Meeting", "Query", "Reply", "Irrelevant"
        ...
        for(Map.Entry<String, Double> entry1 : knowledgeBase.logPriors.entrySet()) {
            ...
            confidence.put(category, logprob);
            
        }
        
        return confidence; //return the category with heighest score
    }
}
